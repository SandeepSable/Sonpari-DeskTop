...
public class TableRowEdit extends JFrame {
	...
	public class LabelCellRenderer extends DefaultTableCellRenderer {
		public Component getTableCellRendererComponent(JTable table, Object oValue, boolean isSelected,
	...
	private class MyMouseAdapter extends MouseAdapter {
		...
		public void mousePressed(MouseEvent evt) {
			...
			if (col == 2) {
				...
				JOptionPane.showMessageDialog(TableRowEdit.this, dialogPanel, "Information",
	...
	private class MyModel extends AbstractTableModel {
		String[] columns = { "Roll No.", "Name", "Action" };
		String[][] inData = { { "1", "Anthony Hopkins", "Edit" }, { "2", "James William", "Edit" },
				{ "3", "Mc. Donald", "Edit" } };
